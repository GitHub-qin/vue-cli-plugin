...
const args = require('minimist')(rawArgv, { boolean: [ 'modern', 'report', 'report-json', 'inline-vue', 'watch', 'open', 'copy', 'https', 'verbose' ] });
...
if (platform && typeof platform === 'string') {
  ...
  let scriptOptions = pkg['uni-app'] || false

  if (scriptOptions && scriptOptions['scripts']) {
      scriptOptions = scriptOptions['scripts'][platform]
  }
